...
EOPHP
		...
		if ! [ -d /var/www/html/wp-content/uploads ]; then
				...
				set_config 'WP_HOME' "$WORDPRESS_SITE_URL"
				set_config 'WP_SITEURL' "$WORDPRESS_SITE_URL"

				echo >&2 "Inicializando carpeta de uploads"
				mkdir /var/www/html/wp-content/uploads
				cp -r /var/www/html/wp-content/_uploads/* /var/www/html/wp-content/uploads
				chown -R www-data:www-data /var/www/html/wp-content/uploads
				chown -Rf www-data:www-data /var/www/html/wordpress.tar
				rm -Rf /var/www/html/wordpress.tar
				chmod -R 775 /var/www/html/
				echo >&2 "Conectando a $WORDPRESS_DB_HOST"
